...
from PongAgents import PongClassicalAgent128PBackbone

@dataclass
class Args:
    exp_name: str = "Pong1PClassicalBaseline" #os.path.basename(__file__)[: -len(".py")]
    ...
    agent_type: str = "classical128P"
    """Only 'classical' is supported in this file"""
    n_layers: str = "Classical_Two_Layers_128_params"
...
if __name__ == "__main__":
    ...
    run_name = f"Pong1PCB2L128P__seed_{args.seed}_{int(time.time())}"
    ...
    agent = PongClassicalAgent128PBackbone(
        env=envs
    ).to(device)

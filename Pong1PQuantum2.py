...
from PongAgents.models2 import PongHybridAgent

@dataclass
class Args:
    exp_name: str = "Pong1PQB2" #os.path.basename(__file__)[: -len(".py")]
...
if __name__ == "__main__":
    ...
    if args.model_save_path is None:
        if not os.path.exists("trained-models"):
            ...
            if not os.path.exists(os.path.join("trained-models", "Pong1PModels2")):
                os.makedirs(os.path.join("trained-models", "Pong1PModels2"))
        args.model_save_path = f"trained-models/Pong1PModels2/{run_name}.pt"
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                ...
                reps = agent.get_representation(next_obs)  # [num_envs, rep_feat_dim]

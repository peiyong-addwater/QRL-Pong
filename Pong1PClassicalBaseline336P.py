...
from PongAgents import PongClassicalAgent336PBackbone
...
class Args:
    ...
    agent_type: str = "classical336P"
    """Only 'classical' is supported in this file"""
    n_layers: str = "Classical_Two_Layers_336_params"
...
if __name__ == "__main__":
    ...
    run_name = f"Pong1PCB2L336P__seed_{args.seed}_{int(time.time())}"
    ...
    agent = PongClassicalAgent336PBackbone(
        env=envs
    ).to(device)

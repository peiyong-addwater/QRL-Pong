...
from model import SeparablePPOAgent as Agent
from model import Backbone
#TODO: enable loading pretrained backbone
...
if __name__ == "__main__":
    ...
    run_name = f"{args.exp_name}__{args.env_id}__{args.seed}__LatentDim__{args.backbone_out_dim}__{int(time.time())}"

...
from PongAgents import PongClassicalAgent256PBackbone
...
class Args:
    ...
    agent_type: str = "classical256P"
    """Only 'classical' is supported in this file"""
    n_layers: str = "Classical_Two_Layers_256_params"
...
if __name__ == "__main__":
    ...
    run_name = f"Pong1PCB2L256P__seed_{args.seed}_{int(time.time())}"
    ...
    agent = PongClassicalAgent256PBackbone(
        env=envs
    ).to(device)

...
class Args:
    ...
    """the type of the agent, choose from ["entangled", "separable", "entangled_trainable_crz", "entangled_trainable_rzz"] """
    n_layers: int = 2
...
if __name__ == "__main__":
    ...
    run_name = f"Pong1PQFM_XObs_{args.agent_type}_QLayers_{args.n_layers}___seed_{args.seed}_{int(time.time())}"
